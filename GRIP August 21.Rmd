...
#### Project Objective: Create a hybrid model for stock price/performance prediction using numerical analysis of historical stock prices, and sentimental analysis of news headlines
...
chartSeries(BAJFINANCE.NS,theme = "white",up.col="light green",dn.col="light blue") 
...
chartSeries(TCS.NS,theme = "white",up.col="light green",dn.col="violet") 
addMACD() # adds moving average convergence divergence signals
addBBands() # Adds Bollinger bands to the stock
addCCI() # Add Commodity channel index. 
addADX() #Add Directional Movement Indicator 
...
chartSeries(RELIANCE.NS,theme = "black",up.col="light blue",dn.col="lavender") 
addMACD() # adds moving average convergence divergence signals
addBBands() # Adds Bollinger bands to the stock
addCCI() # Add Commodity channel index. 
addADX() #Add Directional Movement Indicator 
...
chartSeries(ULTRACEMCO.NS,theme = "white",up.col="light blue",dn.col="light yellow") 
addMACD() # adds moving average convergence divergence signals
addBBands() # Adds Bollinger bands to the stock
addCCI() # Add Commodity channel index. 
addADX() #Add Directional Movement Indicator 
...
chartSeries(BSESN,theme = "white",up.col="pink",dn.col="light blue")
addMACD() # adds moving average convergence divergence signals 
